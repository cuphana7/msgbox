...
;(function() {
   ...
   */
           ...
           console.log('massageArgsJsToNative Start');
           ...
           console.log('massageMessageNativeToJs Start');
           ...
           console.log('convertMessageToArgsNativeToJs Start');
           var args = [];
           ...
           function execProxy() {
           console.log('execProxy Start');
           
           cordovaExec().apply(null, arguments);
           };
           
           execProxy.nativeFetchMessages = function() {
           console.log('execProxy.nativeFetchMessages Start');
           return cordovaExec().nativeFetchMessages.apply(null, arguments);
           };
           
           execProxy.nativeEvalAndFetch = function() {
           console.log('execProxy.nativeEvalAndFetch Start');
           
           return cordovaExec().nativeEvalAndFetch.apply(null, arguments);
           };
           
           execProxy.nativeCallback = function() {
           console.log('execProxy.nativeCallback Start');
